  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center gap-4 mb-2">
        ...
        <div>
          <h1 className="text-3xl font-bold text-app-text tracking-tight">Configurações do Sistema</h1>
          <p className="text-app-text opacity-40 font-medium">Gerencie as diretrizes de transmissão e segurança da mensageria.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 glass-card p-8 relative overflow-hidden group">
            ...
            <div className="relative z-10">
                <div className="flex justify-between items-start mb-8">
                    <div>
                        <h3 className="text-xl font-bold text-app-text opacity-90 mb-2 flex items-center gap-2 tracking-tight">
                            <Globe className="w-5 h-5 text-blue-500" />
                            Ambiente de Transmissão
                        </h3>
                        <p className="text-sm text-app-text opacity-60 max-w-sm font-medium">
        ...
        {/* Quick Info / Tips */}
        <div className="glass-card p-6 space-y-6 flex flex-col justify-center">
            <div className="flex gap-4">
                <div className="mt-1"><Zap className="w-5 h-5 text-amber-500" /></div>
                <div>
                    <h4 className="text-sm font-bold text-app-text opacity-90 mb-1">Assinatura Híbrida</h4>
                    <p className="text-xs text-app-text opacity-40 font-medium">Suporta assinaturas automáticas (A1) e manuais (A3).</p>
                </div>
            </div>
            <div className="flex gap-4">
                <div className="mt-1"><Lock className="w-5 h-5 text-blue-500" /></div>
                <div>
                    <h4 className="text-sm font-bold text-app-text opacity-90 mb-1 text-app-text">Criptografia mTLS</h4>
                    <p className="text-xs text-app-text opacity-40 font-medium">Conexão segura ponto-a-ponto com os servidores do Governo.</p>
                </div>
            </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 opacity-60 grayscale pointer-events-none">
          <div className="glass-card p-6 border-dashed border-app-border">
              <h4 className="text-sm font-bold text-app-text opacity-80 mb-2">Backups Automáticos</h4>
              <p className="text-xs text-app-text opacity-40 font-medium">Configuração de espelhamento de eventos no seu próprio S3.</p>
          </div>
          <div className="glass-card p-6 border-dashed border-app-border">
              <h4 className="text-sm font-bold text-app-text opacity-80 mb-2 font-bold">Webhooks</h4>
              <p className="text-xs text-app-text opacity-40 font-medium">Envio de notificações de recibos para o seu ERP.</p>
          </div>
      </div>
