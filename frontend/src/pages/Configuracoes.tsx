  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center gap-4 mb-2">
        <div className="p-3 bg-primary-500/10 rounded-2xl border border-primary-500/20 shadow-neon-blue">
          <Settings className="w-8 h-8 text-primary-400" />
        </div>
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Configurações do Sistema</h1>
          <p className="text-app-text/40 font-medium">Gerencie as diretrizes de transmissão e segurança da mensageria.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="relative z-10">
                <div className="flex justify-between items-start mb-8">
                    <div>
                        ...
                        <p className="text-sm text-app-text/60 max-w-sm">
                ...
                <div className="flex items-center justify-between p-6 rounded-2xl bg-black/30 border border-white/5 shadow-inner">
        ...
        <div className="glass-panel p-6 space-y-6 flex flex-col justify-center">
            <div className="flex gap-4">
                <div className="mt-1"><Zap className="w-5 h-5 text-primary-400" /></div>
                <div>
                    <h4 className="text-sm font-bold text-white mb-1">Assinatura Híbrida</h4>
                    <p className="text-xs text-app-text/40">Suporta assinaturas automáticas (A1) e manuais (A3).</p>
                </div>
            </div>
            <div className="flex gap-4">
                <div className="mt-1"><Lock className="w-5 h-5 text-cyan-400" /></div>
                <div>
                    <h4 className="text-sm font-bold text-white mb-1">Criptografia mTLS</h4>
                    <p className="text-xs text-app-text/40">Conexão segura ponto-a-ponto com os servidores do Governo.</p>
                </div>
            </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 opacity-40 grayscale pointer-events-none">
          <div className="glass-panel p-6 border-dashed border-white/10">
              <h4 className="text-sm font-bold text-white mb-2">Backups Automáticos</h4>
              <p className="text-xs text-app-text/40">Configuração de espelhamento de eventos no seu próprio S3.</p>
          </div>
          <div className="glass-panel p-6 border-dashed border-white/10">
              <h4 className="text-sm font-bold text-white mb-2">Webhooks</h4>
              <p className="text-xs text-app-text/40">Envio de notificações de recibos para o seu ERP.</p>
          </div>
      </div>
