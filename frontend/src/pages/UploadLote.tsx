  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center space-x-3 mb-2">
         ...
         <div>
            <h2 className="text-2xl font-bold text-app-text tracking-tight">Novo Lote eSocial</h2>
      ...
      <div className="glass-card p-8 flex flex-col space-y-4">
         <div className="flex items-center space-x-2 text-app-text opacity-90">
            <Building2 className="w-5 h-5 text-blue-500" />
            <h3 className="font-bold text-lg tracking-tight">Selecione a Empresa Transmissora</h3>
         </div>
         
          {loadingEmpresas ? (
            <div className="flex items-center p-4 bg-app-tertiary rounded-lg border border-app-border">
               <Loader2 className="w-5 h-5 animate-spin text-blue-500 mr-2" />
               <span className="text-app-text opacity-40 font-medium italic">Buscando empresas cadastradas...</span>
            </div>
         ) : empresas.length === 0 ? (
            <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-lg text-amber-600 text-sm flex items-center font-medium">
            ...
            <select
              className="w-full p-4 border border-app-border rounded-lg outline-none focus:ring-4 focus:ring-blue-500/10 bg-app-bg font-bold text-app-text opacity-80 transition appearance-none cursor-pointer"
              value={empresaId} 
      ...
      >
        ...
        {mutation.isPending ? (
           <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-app-text opacity-90 mb-2">Processando XML...</h3>
           ...
           <div className="text-center relative z-10">
              ...
              <h3 className="text-3xl font-bold text-app-text opacity-90 mb-3 tracking-tight">Solte o seu arquivo aqui</h3>
              <p className="text-app-text opacity-50 font-bold mb-8">ou clique para selecionar do seu computador</p>
